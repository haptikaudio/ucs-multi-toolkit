...
-- @changelog
--   v1.0.2 Full UCS v8.2.1 category and subcategory list
...
local UCS = {
  categories = {
    { id="AIR", name="Air", subs={"Blow", "Burst", "Hiss", "Misc", "Suction"} },
    { id="AERO", name="Aircraft", subs={"Door", "Helicopter", "Interior", "Jet", "Mechanism", "Military", "Misc", "Prop", "Radio Controlled", "Rocket"} },
    { id="ALRM", name="Alarms", subs={"Bell", "Buzzer", "Clock", "Electronic", "Misc", "Siren"} },
    { id="AMB", name="Ambience", subs={"Air", "Alpine", "Amusement", "Birdsong", "Celebration", "Construction", "Desert", "Designed", "Emergency", "Fantasy", "Farm", "Forest", "Grassland", "Historical", "Hitech", "Hospital", "Industrial", "Insect", "Lakeside", "Market", "Misc", "Nautical", "Office", "Park", "Prison", "Protest", "Public Place", "Religious", "Residential", "Restaurant & Bar", "Room Tone", "Rural", "School", "Scifi", "Seaside", "Sport", "Suburban", "Swamp", "Town", "Traffic", "Transportation", "Tropical", "Tundra", "Underground", "Underwater", "Urban", "Warfare"} },
    { id="ANML", name="Animals", subs={"Amphibian", "Aquatic", "Bat", "Cat Domestic", "Cat Wild", "Dog", "Dog Wild", "Farm", "Horse", "Insect", "Misc", "Primate", "Reptile", "Rodent", "Wild"} },
    { id="ADR", name="Archived", subs={"Adr", "Asset", "Bounce", "Impulse Response", "Loop Group", "Mix", "Pfx", "Production", "Raw", "Reference", "Scene", "Test Tone", "Trademarked", "Work In Progress", "Wtf"} },
    { id="BEEP", name="Beeps", subs={"Appliance", "General", "Lofi", "Medical", "Timer", "Vehicle"} },
    { id="BELL", name="Bells", subs={"Animal", "Doorbell", "Gong", "Handbell", "Large", "Misc"} },
    { id="BIRD", name="Birds", subs={"Bird Of Prey", "Crow", "Fowl", "Misc", "Sea", "Songbird", "Tropical", "Wading"} },
    { id="BOAT", name="Boats", subs={"Air Boat", "Bow Wash", "Door", "Electric", "Fishing", "Horn", "Interior", "Mechanism", "Military", "Misc", "Motorboat", "Racing", "Rowboat", "Sailboat", "Ship", "Steam", "Submarine", "Underwater"} },
    { id="BLLT", name="Bullets", subs={"By", "Impact", "Misc", "Ricochet", "Shell"} },
    { id="TOON", name="Cartoon", subs={"Animal", "Boing", "Clang", "Creak", "Horn", "Impact", "Machine", "Misc", "Musical", "Pluck", "Pop", "Shake", "Splat", "Squeak", "Stretch", "Swish", "Twang", "Vehicle", "Vocal", "Warble", "Whistle", "Zip"} },
    { id="CERM", name="Ceramics", subs={"Break", "Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="CHAIN", name="Chains", subs={"Break", "Handle", "Impact", "Misc", "Movement"} },
    { id="CHEM", name="Chemicals", subs={"Acid", "Misc", "Reaction"} },
    { id="CLOCK", name="Clocks", subs={"Chime", "Mechanics", "Misc", "Tick"} },
    { id="CLOTH", name="Cloth", subs={"Flap", "Handle", "Impact", "Misc", "Movement", "Rip"} },
    { id="COM", name="Communications", subs={"Audio Visual", "Camera", "Cellphone", "Microphone", "Misc", "Phonograph", "Radio", "Static", "Telemetry", "Telephone", "Television", "Transceiver", "Typewriter"} },
    { id="CMPT", name="Computers", subs={"Hard Drive", "Keyboard & Mouse", "Misc"} },
    { id="CREA", name="Creatures", subs={"Aquatic", "Avian", "Beast", "Blob", "Dinosaur", "Dragon", "Elemental", "Ethereal", "Humanoid", "Insectoid", "Misc", "Monster", "Reptilian", "Small", "Source"} },
    { id="CRWD", name="Crowds", subs={"Angry", "Applause", "Battle", "Celebration", "Cheering", "Children", "Conversation", "Laughter", "Loop Group", "Misc", "Panic", "Quiet", "Reaction", "Singing", "Sport", "Walla"} },
    { id="DSGN", name="Designed", subs={"Bass Dive", "Boom", "Braam", "Distortion", "Drone", "Eerie", "Ethereal", "Granular", "Impact", "Misc", "Morph", "Riser", "Rumble", "Rhythmic", "Source", "Stinger", "Synthetic", "Tonal", "Vocal", "Whoosh"} },
    { id="DESTR", name="Destruction", subs={"Collapse", "Crash & Debris", "Misc"} },
    { id="DIRT", name="Dirt & Sand", subs={"Crash & Debris", "Dust", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="DOOR", name="Doors", subs={"Antique", "Appliance", "Cabinet", "Composite", "Creak", "Dungeon", "Electric", "Gate", "Glass", "Hardware", "Hitech", "Hydraulic & Pneumatic", "Knock", "Metal", "Misc", "Plastic", "Prison", "Revolving", "Sliding", "Stone", "Swinging", "Wood"} },
    { id="DRWR", name="Drawers", subs={"Metal", "Misc", "Plastic", "Wood"} },
    { id="ELEC", name="Electricity", subs={"Arc", "Buzz & Hum", "Electromagnetic", "Misc", "Sparks", "Zap"} },
    { id="EQUIP", name="Equipment", subs={"Bridle & Tack", "Hitech", "Misc", "Recreational", "Sport", "Tactical"} },
    { id="EXPL", name="Explosions", subs={"Designed", "Misc", "Real"} },
    { id="FART", name="Farts", subs={"Designed", "Misc", "Real"} },
    { id="FGHT", name="Fight", subs={"Bodyfall", "Cloth", "Grab", "Impact", "Misc"} },
    { id="FIRE", name="Fire", subs={"Burning", "Burst", "Crackle", "Gas", "Ignite", "Misc", "Sizzle", "Torch", "Turbulent", "Whoosh"} },
    { id="FRWK", name="Fireworks", subs={"Commercial", "Misc", "Recreational"} },
    { id="FOLY", name="Foley", subs={"Cloth", "Feet", "Hands", "Misc", "Prop"} },
    { id="FOOD", name="Food & Drink", subs={"Cooking", "Drinking", "Eating", "Glassware", "Ingredients", "Kitchenware", "Misc", "Pour", "Tableware"} },
    { id="FEET", name="Footsteps", subs={"Animal", "Creature", "Horse", "Human", "Misc"} },
    { id="GAME", name="Games", subs={"Arcade", "Board", "Casino", "Misc", "Video"} },
    { id="GEO", name="Geothermal", subs={"Fumarole", "Geyser", "Lava", "Misc", "Mud Pots"} },
    { id="GLAS", name="Glass", subs={"Break", "Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="GORE", name="Gore", subs={"Blood", "Bone", "Burn", "Flesh", "Misc", "Ooze", "Source", "Splat", "Squish", "Stab"} },
    { id="GUN", name="Guns", subs={"Antique", "Artillery", "Automatic", "Cannon", "Handle", "Hitech", "Mechanism", "Misc", "Pistol", "Rifle", "Shotgun", "Suppressed"} },
    { id="HORN", name="Horns", subs={"Air Powered", "Celebration", "Misc", "Traditional"} },
    { id="HMN", name="Human", subs={"Blow", "Breath", "Burp", "Cough", "Heartbeat", "Kiss", "Misc", "Pee", "Skin", "Sneeze", "Sniff", "Snore", "Spit", "Vomit"} },
    { id="ICE", name="Ice", subs={"Break", "Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="LASR", name="Lasers", subs={"Beam", "Gun", "Impact", "Misc"} },
    { id="LETHR", name="Leather", subs={"Creak", "Handle", "Impact", "Misc", "Movement"} },
    { id="LIQ", name="Liquid & Mud", subs={"Bubbles", "Impact", "Misc", "Movement", "Suction"} },
    { id="MACH", name="Machines", subs={"Amusement", "Antique", "Appliance", "Construction", "Elevator", "Escalator", "Fan", "Garden", "Gym", "Hitech", "Hvac", "Industrial", "Mechanism", "Medical", "Misc", "Office", "Pump"} },
    { id="MAG", name="Magic", subs={"Angelic", "Elemental", "Evil", "Misc", "Poof", "Shimmer", "Spell"} },
    { id="MECH", name="Mechanical", subs={"Click", "Gears", "Hydraulic & Pneumatic", "Latch", "Lever", "Lock", "Misc", "Pulley", "Ratchet", "Relay", "Roller", "Switch"} },
    { id="METL", name="Metal", subs={"Break", "Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="MOTR", name="Motors", subs={"Antique", "Combustion", "Electric", "Misc", "Servo", "Turbine"} },
    { id="MOVE", name="Movement", subs={"Activity", "Animal", "Creature", "Crowd", "Human", "Insect", "Misc", "Presence"} },
    { id="MUSC", name="Musical", subs={"Bells", "Brass", "Chime", "Choral", "Experimental", "Instrument", "Keyed", "Loop", "Misc", "Percussion", "Percussion Tuned", "Performance", "Plucked", "Sample", "Shaken", "Song & Phrase", "Stinger", "Stringed", "Synthesized", "Toy", "Woodwind"} },
    { id="NATD", name="Natural Disaster", subs={"Avalanche", "Earthquake", "Misc", "Tornado", "Tsunami", "Typhoon", "Volcano"} },
    { id="OBJ", name="Objects", subs={"Bag", "Book", "Coin", "Container", "Fashion", "Furniture", "Garden", "Gym", "Household", "Jewelry", "Keys", "Luggage", "Medical", "Misc", "Office", "Packaging", "Tape", "Umbrella", "Wheeled", "Writing", "Zipper"} },
    { id="PAPR", name="Paper", subs={"Flutter", "Friction", "Handle", "Impact", "Misc", "Rip", "Tonal"} },
    { id="PLAS", name="Plastic", subs={"Break", "Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="RAIN", name="Rain", subs={"Cloth", "Concrete", "General", "Glass", "Interior", "Metal", "Plastic", "Vegetation", "Water", "Wood"} },
    { id="ROBT", name="Robots", subs={"Misc", "Movement", "Vocal"} },
    { id="ROCK", name="Rocks", subs={"Break", "Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="ROPE", name="Rope", subs={"Creak", "Handle", "Impact", "Misc", "Movement"} },
    { id="RUBR", name="Rubber", subs={"Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
    { id="SCI", name="Scifi", subs={"Alarm", "Computer", "Door", "Energy", "Impact", "Machine", "Mechanism", "Misc", "Retro", "Spaceship", "Vehicle", "Weapon"} },
    { id="SNOW", name="Snow", subs={"Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement"} },
    { id="SPRT", name="Sports", subs={"Court", "Field", "Gym", "Indoor", "Misc", "Skate", "Track & Field", "Water", "Winter"} },
    { id="SWSH", name="Swooshes", subs={"Swish", "Whoosh"} },
    { id="TOOL", name="Tools", subs={"Garden", "Hand", "Misc", "Pneumatic", "Power"} },
    { id="TOY", name="Toys", subs={"Electronic", "Mechanical", "Misc"} },
    { id="TRN", name="Trains", subs={"Brake", "Clack", "Door", "Diesel", "Electric", "High Speed", "Horn", "Interior", "Mechanism", "Misc", "Steam", "Subway", "Tram"} },
    { id="UI", name="User Interface", subs={"Alert", "Beep", "Click", "Data", "Glitch", "Misc", "Motion"} },
    { id="VEGE", name="Vegetation", subs={"Grass", "Leaves", "Misc", "Tree"} },
    { id="VEH", name="Vehicles", subs={"Alarm", "Antique", "Atv", "Bicycle", "Brake", "Bus", "Car", "Construction", "Door", "Electric", "Emergency", "Farm", "Freight", "Generic By", "Horn", "Interior", "Jalopy", "Mechanism", "Military", "Misc", "Motorcycle", "Racing", "Siren", "Skid", "Suspension", "Tire", "Truck Van & Suv", "Utility", "Wagon", "Window"} },
    { id="VOX", name="Voices", subs={"Alien", "Baby", "Cheer", "Child", "Crying", "Efforts", "Female", "Futzed", "Historical", "Laugh", "Male", "Misc", "Reaction", "Scream", "Singing", "Whisper"} },
    { id="WATR", name="Water", subs={"Bubbles", "Drain", "Drip", "Fizz", "Flow", "Fountain", "Impact", "Lap", "Misc", "Movement", "Plumbing", "Pour", "Splash", "Spray", "Steam", "Surf", "Turbulent", "Underwater", "Waterfall", "Wave"} },
    { id="WEAP", name="Weapons", subs={"Armor", "Arrow", "Axe", "Blunt", "Bow", "Knife", "Misc", "Polearm", "Siege", "Sword", "Whip"} },
    { id="HAIL", name="Weather", subs={"Hail", "Misc", "Storm", "Thunder"} },
    { id="WHST", name="Whistles", subs={"Human", "Mechanical", "Misc"} },
    { id="WIND", name="Wind", subs={"Designed", "General", "Gust", "Interior", "Tonal", "Turbulent", "Vegetation"} },
    { id="WNDW", name="Windows", subs={"Covering", "Hardware", "Knock", "Metal", "Misc", "Plastic", "Wood"} },
    { id="WING", name="Wings", subs={"Bird", "Creature", "Insect", "Misc"} },
    { id="WOOD", name="Wood", subs={"Break", "Crash & Debris", "Friction", "Handle", "Impact", "Misc", "Movement", "Tonal"} },
  }
}
...
local KEYWORD_HINTS = {
  footstep = { cat = "FEET", weight = 22 },
  footsteps = { cat = "FEET", weight = 22 },
  footfall = { cat = "FOLY", sub = "Feet", weight = 20 },
  walk = { cat = "FEET", sub = "Human", weight = 16 },
  walking = { cat = "FEET", sub = "Human", weight = 18 },
  run = { cat = "FEET", sub = "Human", weight = 14 },
  running = { cat = "FEET", sub = "Human", weight = 16 },
  stomp = { cat = "FEET", sub = "Human", weight = 16 },
  whoosh = { cat = "SWSH", sub = "Whoosh", weight = 24 },
  swoosh = { cat = "SWSH", sub = "Swish", weight = 24 },
  swish = { cat = "SWSH", sub = "Swish", weight = 20 },
  wind = { cat = "WIND", weight = 18 },
  breeze = { cat = "WIND", sub = "General", weight = 20 },
  gust = { cat = "WIND", sub = "Gust", weight = 20 },
  rain = { cat = "RAIN", sub = "General", weight = 20 },
  thunder = { cat = "HAIL", sub = "Thunder", weight = 22 },
  explosion = { cat = "EXPL", weight = 22 },
  explode = { cat = "EXPL", weight = 20 },
  blast = { cat = "DSGN", sub = "Boom", weight = 20 },
  boom = { cat = "DSGN", sub = "Boom", weight = 24 },
  impact = { cat = "FOLY", sub = "Prop", weight = 14 },
  hit = { cat = "FOLY", sub = "Prop", weight = 14 },
  punch = { cat = "FGHT", weight = 16 },
  slap = { cat = "FGHT", weight = 16 },
  glass = { cat = "GLAS", weight = 22 },
  ceramic = { cat = "CERM", weight = 20 },
  plastic = { cat = "PLAS", weight = 20 },
  paper = { cat = "PAPR", weight = 18 },
  rubber = { cat = "RUBR", weight = 18 },
  leather = { cat = "LETHR", weight = 18 },
  stone = { cat = "ROCK", weight = 18 },
  wood = { cat = "WOOD", weight = 16 },
  wooden = { cat = "WOOD", weight = 16 },
  creak = { cat = "WOOD", sub = "Friction", weight = 22 },
  splinter = { cat = "WOOD", sub = "Break", weight = 20 },
  metal = { cat = "METL", weight = 16 },
  metallic = { cat = "METL", weight = 14 },
  steel = { cat = "METL", weight = 16 },
  cloth = { cat = "CLOTH", weight = 18 },
  fabric = { cat = "CLOTH", weight = 16 },
  ui = { cat = "UI", weight = 18 },
  click = { cat = "UI", sub = "Click", weight = 18 },
  button = { cat = "UI", sub = "Click", weight = 16 },
  beep = { cat = "BEEP", sub = "General", weight = 20 },
  computer = { cat = "CMPT", weight = 18 },
  robot = { cat = "ROBT", weight = 18 },
  laser = { cat = "LASR", weight = 20 },
  servo = { cat = "MOTR", sub = "Servo", weight = 22 },
  motor = { cat = "MOTR", weight = 18 },
  engine = { cat = "MACH", weight = 20 },
  machine = { cat = "MACH", weight = 16 },
  crowd = { cat = "CRWD", weight = 20 },
  applause = { cat = "CRWD", sub = "Applause", weight = 22 },
  chatter = { cat = "CRWD", sub = "Conversation", weight = 20 },
  dog = { cat = "ANML", sub = "Dog", weight = 18 },
  cat = { cat = "ANML", sub = "Cat Domestic", weight = 14 },
  bird = { cat = "BIRD", weight = 20 },
  insect = { cat = "ANML", sub = "Insect", weight = 20 },
  animal = { cat = "ANML", weight = 18 },
  water = { cat = "WATR", weight = 18 },
  splash = { cat = "WATR", sub = "Impact", weight = 22 },
  drip = { cat = "WATR", sub = "Drip", weight = 22 },
  pour = { cat = "WATR", sub = "Flow", weight = 18 },
  ocean = { cat = "WATR", sub = "Lap", weight = 20 },
  stream = { cat = "WATR", sub = "Flow", weight = 18 },
  fire = { cat = "FIRE", weight = 20 },
  flame = { cat = "FIRE", sub = "Burning", weight = 18 },
  breath = { cat = "HMN", sub = "Breath", weight = 20 },
  cough = { cat = "HMN", sub = "Cough", weight = 20 },
  scream = { cat = "VOX", sub = "Scream", weight = 22 },
  whisper = { cat = "VOX", sub = "Whisper", weight = 20 },
  voice = { cat = "VOX", weight = 18 },
  laugh = { cat = "VOX", sub = "Laugh", weight = 20 },
  car = { cat = "VEH", sub = "Car", weight = 20 },
  truck = { cat = "VEH", sub = "Truck Van & Suv", weight = 20 },
  train = { cat = "TRN", weight = 20 },
  plane = { cat = "AERO", sub = "Jet", weight = 20 },
  helicopter = { cat = "AERO", sub = "Helicopter", weight = 22 },
  boat = { cat = "BOAT", weight = 20 },
  ambience = { cat = "AMB", weight = 18 },
  ambient = { cat = "AMB", weight = 16 },
  lock = { cat = "MECH", sub = "Lock", weight = 20 },
  unlock = { cat = "MECH", sub = "Lock", weight = 18 },
  latch = { cat = "DOOR", sub = "Hardware", weight = 18 },
  door = { cat = "DOOR", weight = 18 },
  electricity = { cat = "ELEC", weight = 18 },
  electric = { cat = "ELEC", weight = 16 },
  spark = { cat = "ELEC", sub = "Sparks", weight = 20 },
  buzz = { cat = "ELEC", sub = "Buzz & Hum", weight = 18 },
  hum = { cat = "ELEC", sub = "Buzz & Hum", weight = 16 },
  zap = { cat = "ELEC", sub = "Zap", weight = 18 },
  scrape = { cat = "DSGN", sub = "Granular", weight = 12 },
  rattle = { cat = "OBJ", weight = 14 },
  thud = { cat = "DSGN", sub = "Impact", weight = 14 },
  debris = { cat = "DESTR", weight = 14 },
  gun = { cat = "GUN", weight = 20 },
  weapon = { cat = "WEAP", weight = 18 },
  music = { cat = "MUSC", weight = 18 },
  stinger = { cat = "MUSC", sub = "Stinger", weight = 20 },
  designed = { cat = "DSGN", weight = 14 },
  abstract = { cat = "DSGN", sub = "Ethereal", weight = 16 },
  alarm = { cat = "ALRM", weight = 18 },
  bell = { cat = "BELL", weight = 18 },
  siren = { cat = "ALRM", sub = "Siren", weight = 20 },
  snow = { cat = "SNOW", weight = 18 },
  ice = { cat = "ICE", weight = 18 },
  gore = { cat = "GORE", weight = 18 },
  magic = { cat = "MAG", weight = 18 },
  scifi = { cat = "SCI", weight = 18 },
  ["break"] = { cat = "DESTR", weight = 12 },
  smash = { cat = "DESTR", weight = 16 },
  crack = { cat = "DSGN", sub = "Impact", weight = 12 },
}
